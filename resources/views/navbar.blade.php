...
<head>
    ...
    <style>
        ...
        .notification-item {
            ...
            align-items: center;
            width: 300px;
            max-height: 4.5em; /* ความสูงสูงสุด 3 บรรทัด */
            overflow: hidden;
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="notificationDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <span class="badge bg-danger" id="unreadNotificationsCount">{{ $unreadNotificationsCount }}</span> <!-- แสดงจำนวนการแจ้งเตือนที่ยังไม่ได้อ่าน -->
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="notificationDropdown">
                            @foreach ($notifications as $notification)
                                ...
                                <li class="notification-item">
                                    ...
                                    <button class="btn btn-link notification-delete" data-id="{{ $notification->id }}">&times;</button>
                                </li>
                            @endforeach
                        </ul>
                    </li>
        ...
        $(document).on('click', '.notification-delete', function(event) {
            ...
            $.ajax({
                ...
                error: function(err) {
                    ...
                    alert('Error deleting notification: ' + (err.responseJSON ? err.responseJSON.message : 'Unknown error'));
                }
            });
        });
    });
